                            ...
                            <div class="table-responsive text-nowrap">
                                <table class="datatables-depositproblem table">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        <?php
                                        $Query = mysqli_query($conn, "SELECT id, userid, deposit_order_no,bank_account_number,ifsc, order_amount, text_content, CardName, remarks FROM your_table WHERE prob = 'Change bank name' AND status = 2");
                                ...
                                <div class="row">
                                  <div class="col mb-6 mt-2">
                                    <div class="form-floating form-floating-outline">
                                      ...
                                      <input type="hidden" id="formid" value="89" name='formid'/>
