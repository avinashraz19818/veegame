...
<head>
    ...
    <title>Withdraw Apply Bank</title>
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="card">
                            <div class="d-flex justify-content-between align-items-center px-4">
                                <h4 class="m-5">Withdraw Apply Bank</h4>
                                ...
                                <?php else: ?>
                                    <div class="text-center py-5">
                                        <div class="text-muted">
                                            ...
                                            <p class="mt-3 mb-0">No withdrawal requests found</p>
            ...
            <div class="modal-content">
                <form id="rejectForm" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <p>Are you sure you want to reject this withdrawal request of <strong>₹<span id="reject_amount"></span></strong>?</p>
                        </div>
                        <div class="mb-3">
            ...
            <div class="modal-content">
                <form id="acceptForm" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <p>Are you sure you want to accept this withdrawal request of <strong>₹<span id="accept_amount"></span></strong>?</p>
    ...
    <script>
        ...
        $('#acceptForm, #rejectForm').on('submit', function(e) {
            ...
            const confirmMessage = action === 'accept' 
                ? `Are you sure you want to accept this withdrawal request of ₹${amount}?`
                : `Are you sure you want to reject this withdrawal request of ₹${amount}?`;
