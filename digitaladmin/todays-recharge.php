                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card">
                            <div class="table-responsive text-nowrap">
                                <h4 class="p-5">Today's Recharge</h4>
                                <table class="datatables-depositaccepted table">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        ...
                                        $Query = mysqli_query($conn, "SELECT * FROM thevani WHERE sthiti = '1' AND balakedara NOT IN (SELECT balakedara FROM `demo` WHERE `sthiti`='1') AND DATE(dinankavannuracisi) = DATE('" . $curdate . "')");
                                        $i = 0;
