                            ...
                            <div class="table-responsive text-nowrap">
                                <div class="d-flex justify-content-between align-items-center px-4">
                                    <div class="d-flex align-items-center">
                                        <h4 class="m-5">Refferal Bonus</h4>
                                        <input type="number" class="form-control" id="Auid"
                                        placeholder="Enter Agent UID" autofocus />
                                      
                                      <input type="number" class="form-control" id="uid"
                                        placeholder="Enter Member UID" autofocus />
                                ...
                                <table class="table" id="example1">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                         <?php
                                        $sql = "SELECT * FROM invite_bonus_table WHERE DATE(shonu) = '$date'";
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                <tr>
                                                    <td><?= $row["userkani"]; ?></td>
                                                    <td><?= $row["reffer"]; ?></td>
                                                    <td><?= number_format($row["firstdeposit"]); ?></td>
