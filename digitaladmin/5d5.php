...
<body>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card mb-5 p-5">
                            ...
                            <form class="row g-6 mb-6 justify-content-center" action="api/prediction-set.php" id="pre" method="POST">
                                <div class="col-sm-12 col-xl-12 col-lg-12 col-md-12 d-flex justify-content-center align-items-center">
                                    ...
                                    <input type="hidden" name="type" value="5d5">
                        ...
                        <?php $adminGameType='5d5'; $adminHasBetDetails=false; require __DIR__.'/includes/live_big_small.php'; ?>
                        <div class="card mt-5">
	...
	function wingoonetotal()
	{
		...
		$.ajax({
		type: "Post",
		url: "api/total-bet-amount.php?periodid=" + periodid+"&type=5d5",
	...
	function refreshLiveBets() {
	    ...
	    let endpoint = "api/live-game-bets.php?type=5d5&periodid=" + encodeURIComponent(periodid);
...
function startTimer(startTime, endTime) {
    ...
    function fetchServerTime() {
        return fetch('api/servertime.php?type=5d5')
            .then(response => {
                if (!response.ok) {
