...
<head>
    ...
    <title>Approved UPI Withdrawals</title>
...
<body>
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="card">
                            <div class="d-flex justify-content-between align-items-center px-4">
                                <h4 class="m-5">Approved UPI Withdrawals</h4>
                            ...
                            <div class="table-responsive text-nowrap">
                                <?php
                                // Build query based on date filter - ONLY UPI (madari = 2) and Approved (sthiti = 1)
                                $query = "SELECT h.*, 
                                ...
                                <table class="datatables-withdrawsent-upi table">
                                    <thead>
                                        <tr>
                                            <th>Sr. No</th>
                                            <th>User ID</th>
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        ...
                                        while ($row = mysqli_fetch_array($Query)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge rounded-pill badge-upi me-1">
                                                        UPI
                                                    </span>
                                                </td>
                                                <td><?= $requestDate; ?></td>
                                                ...
                                                <td>
                                                    <div class="action-buttons">
                                                        <!-- View Button (Only View - No Action Buttons) -->
                                                        <button type="button" class="btn btn-info btn-sm view-details" 
                                                            ...
                                                            data-orderid="<?= htmlspecialchars($row['dharavahi']); ?>">
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="3" class="text-end"><strong>Total Approved Amount:</strong></td>
                                ...
                                <?php else: ?>
                                    <div class="text-center py-5">
                                        <div class="text-muted">
                                            ...
                                            <p class="mt-3 mb-0">No approved UPI withdrawals found</p>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Approved UPI Withdrawal Details</h5>
                ...
                <div class="modal-body">
                    <div class="details-section">
                        ...
                        <div class="detail-row">
                            ...
                            <span class="detail-value" id="detail-orderid"></span>
                        </div>
                    </div>
    ...
    <script>
        ...
        $(document).on('click', '.view-details', function() {
            ...
            $('#detail-orderid').text($(this).data('orderid'));
        ...
        <?php if ($totalRecords > 0): ?>
        $(function () {
            $('.datatables-withdrawsent-upi').DataTable({
                "paging": true,
                "lengthChange": true,
                "searching": true,
                "ordering": true,
                ...
                "order": [[0, "asc"]],
                "columnDefs": [
                    { "orderable": false, "targets": [9] } // Make Actions column non-orderable
                ]
            });
        });
        <?php endif; ?>
