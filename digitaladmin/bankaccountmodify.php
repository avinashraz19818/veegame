...
<head>
    ...
    <title>Bank Account Modification</title>
...
<body>
    ...
    <tbody class="table-border-bottom-0">
        <?php
        $Query = mysqli_query($conn, "SELECT * FROM your_table WHERE prob = 'Delete Withdraw Bank Account and Rebind' AND status = 2");
        ...
        ?>
            <tr>
                ...
                <td>
                    <a href="<?= $row['image_url_1']; ?>" target="_blank" title="View Bank Passbook">
                        <i class="ri-image-line fs-4 text-primary"></i>
                    </a>
                </td>
                <td>
                    <a href="<?= $row['image_url_2']; ?>" target="_blank" title="View Photo Selfie">
                        <i class="ri-image-line fs-4 text-primary"></i>
                    </a>
                </td>
                <td>
                    <a href="<?= $row['image_url_3']; ?>" target="_blank" title="View Deposit Receipt">
                        <i class="ri-image-line fs-4 text-primary"></i>
                    </a>
                </td>
                ...
                <td>
                    <button class="btn btn-primary edit-btn" 
                            ...
                            data-formid="89"
                            data-bs-target="#deposit-problem-modal" 
                            data-bs-toggle="modal">
                        <i class="ri-chat-new-line text-white me-1"></i>Do Response
                    </button>
                </td>
                <td>
                    <button class="btn btn-danger edit-btn" 
                            ...
                            data-bs-target="#deposit-problem-modal" 
                            data-bs-toggle="modal">
                        <i class="ri-chat-new-line text-white me-1"></i>Reject request
                    </button>
                </td>
            </tr>
        <?php } ?>
                                ...
                                <div class="row">
                                  <div class="col mb-6 mt-2">
                                    <div class="form-floating form-floating-outline">
                                      ...
                                      <input type="hidden" id="formid" value="15" name='formid'/>
    ...
    const formId = $(this).data('formid'); // Get formid from button
    
    $('#id').val(dataId);
    $('#remarks').val(dataRemarks);
    $('#formid').val(formId); // Set the formid in hidden input
});
