...
try {
    $pendingOverride = sl_admin_override_get_pending($conn, 'WinGo_1M');
...
<body>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <?php $adminGameType='wingo1'; $adminHasBetDetails=true; require __DIR__.'/includes/live_big_small.php'; ?>
                        <div class="card mt-5">
                        ...
                        <form action="api/prediction-set.php" id="pre" method="POST">
                            ...
                            <input type="hidden" name="type" value="wingo1">
	...
	function getbettingdata(actiontype)
	{
		let periodid=document.getElementById('curr-period').innerHTML;
			$.ajax({
			type: "GET",
			url: "api/game-bet-summary.php?type=wingo1&periodid=" + encodeURIComponent(periodid),
			dataType: "json",
	...
	function wingoonetotal()
	{
		...
		$.ajax({
		type: "Post",
		url: "api/total-bet-amount.php?periodid=" + periodid+"&type=wingo1",
	...
	function refreshLiveBets() {
	    ...
	    let endpoint = "api/live-game-bets.php?type=wingo1&periodid=" + encodeURIComponent(periodid);
...
function startTimer(startTime, endTime) {
    ...
    function fetchServerTime() {
        return fetch('api/servertime.php?type=wingo1')
            .then(response => {
                if (!response.ok) {
