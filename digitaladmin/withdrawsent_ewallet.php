...
<head>
    ...
    <title>Approved E-Wallet Withdrawals</title>
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="card">
                            <div class="d-flex justify-content-between align-items-center px-4">
                                <h4 class="m-5">Approved E-Wallet Withdrawals</h4>
                            ...
                            <div class="table-responsive text-nowrap">
                                <?php
                                // Build query based on date filter - ONLY E-WALLET (madari = 4) and Approved (sthiti = 1)
                                $query = "SELECT h.*, 
                                ...
                                <?php else: ?>
                                    <div class="text-center py-5">
                                        <div class="text-muted">
                                            ...
                                            <p class="mt-3 mb-0">No approved E-Wallet withdrawals found</p>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">E-Wallet Withdrawal Details</h5>
