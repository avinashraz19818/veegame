...
<head>
  ...
  <title>Withdrawal Problems</title>
              ...
              <div class="table-responsive text-nowrap">
                <table class="datatables-depositproblem table">
                  ...
                  <tbody class="table-border-bottom-0">
                    <?php
                    $Query = mysqli_query($conn, "SELECT id, userid, deposit_order_no,image_upload,file_upload, order_amount, text_content, remarks FROM your_table WHERE prob = 'Withdrawal problem' AND status = 2");
                  ...
                  <div class="row">
                    <div class="col mb-6 mt-2">
                      <div class="form-floating form-floating-outline">
                        ...
                        <input type="hidden" id="formid" value="25" name='formid' />
