...
<head>
    ...
    <title>Rejected UPI Withdrawals</title>
...
<body>
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="card">
                            <div class="d-flex justify-content-between align-items-center px-4">
                                <h4 class="m-5">Rejected UPI Withdrawals</h4>
                            ...
                            <div class="table-responsive text-nowrap">
                                <?php
                                // Build query based on date filter - ONLY UPI (madari = 2) and Rejected (sthiti = 2)
                                $query = "SELECT h.*, 
                                ...
                                <table class="datatables-withdrawreject-upi table">
                                    <thead>
                                        <tr>
                                            <th>Sr. No</th>
                                            <th>User ID</th>
                                ...
                                <?php else: ?>
                                    <div class="text-center py-5">
                                        <div class="text-muted">
                                            ...
                                            <p class="mt-3 mb-0">No rejected UPI withdrawals found</p>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Rejected UPI Withdrawal Details</h5>
    ...
    <script>
        ...
        <?php if ($totalRecords > 0): ?>
        $(function () {
            $('.datatables-withdrawreject-upi').DataTable({
                "paging": true,
                "lengthChange": true,
                "searching": true,
                "ordering": true,
