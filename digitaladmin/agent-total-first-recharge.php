                                ...
                                <table class="table" id="example1">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        ...
                                        $sql = "WITH FirstRecharges AS (
                                                ...
                                                SELECT ss.id, ss.mobile, fr.first_recharge_amount 
                                                FROM FirstRecharges fr
                                                JOIN shonu_subjects ss ON fr.user_id = ss.id 
                                                WHERE ss.code".($level-1==0?'':$level-1)." = '$ownCode' 
                                                AND DATE(fr.first_recharge_date) = '$date';
                                        ...
                                        $result = mysqli_query($conn, $sql);
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {$i++;
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= number_format($row["first_recharge_amount"]); ?></td>
                                                </tr>
                                                <?php
                                            }
                                        ?>
