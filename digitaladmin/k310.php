...
<body>
                        ...
                        <div class="card mb-5 p-5">
                            ...
                            <form class="row g-6 mb-6 justify-content-center" action="api/prediction-set.php" id="pre" method="POST">
                                <div class="col-sm-12 col-xl-12 col-lg-12 col-md-12 d-flex justify-content-center align-items-center">
                                    <input type="number" name="username" max="666" min="111" id="next" placeholder="Enter a number from 111-666" class="flex-grow-1 cool-input p-3" style="height: 40px;">
                                    <input type="hidden" name="type" value="k310">
                                    <input type="hidden" name="issue_number" id="issue-number">
                                </div>
                                <div class="col-sm-12 col-xl-12 col-lg-12 col-md-12 d-flex justify-content-center align-items-center">
                                    <button class="btn btn-success w-100" type="submit">Set prediction</button>
                                </div>
                            </form>
                        </div>
                        
                        <?php $adminGameType='k310'; $adminHasBetDetails=false; require __DIR__.'/includes/live_big_small.php'; ?>
                        <div class="card mt-5">
	...
	function wingoonetotal()
	{
		...
		$.ajax({
		type: "Post",
		url: "api/total-bet-amount.php?periodid=" + periodid+"&type=k310",
	...
	function refreshLiveBets() {
	    ...
	    let endpoint = "api/live-game-bets.php?type=k310&periodid=" + encodeURIComponent(periodid);
...
function startTimer(startTime, endTime) {
    ...
    function fetchServerTime() {
        return fetch('api/servertime.php?type=k310')
            .then(response => {
                if (!response.ok) {
