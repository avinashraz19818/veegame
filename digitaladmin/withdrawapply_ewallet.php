...
<head>
    ...
    <title>Withdraw Apply E-Wallet</title>
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="card">
                            <div class="d-flex justify-content-between align-items-center px-4">
                                <h4 class="m-5">Withdraw Apply E-Wallet</h4>
                            ...
                            <div class="table-responsive text-nowrap">
                                <?php
                                // Build query based on date filter - ONLY E-WALLET (madari = 4)
                                $query = "SELECT h.*,  
                                ...
                                <?php else: ?>
                                    <div class="text-center py-5">
                                        <div class="text-muted">
                                            ...
                                            <p class="mt-3 mb-0">No E-Wallet withdrawal requests found</p>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">E-Wallet Withdrawal Request Details</h5>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="rejectForm" method="POST">
                    <div class="modal-header">
                        <h5 class="modal-title">Reject E-Wallet Withdrawal Request</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <p>Are you sure you want to reject this E-Wallet withdrawal request of <strong>₹<span id="reject_amount"></span></strong>?</p>
                        </div>
                        <div class="mb-3">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="acceptForm" method="POST">
                    <div class="modal-header">
                        <h5 class="modal-title">Accept E-Wallet Withdrawal Request</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <input type="hidden" name="withdraw_id" id="accept_withdraw_id">
                        <input type="hidden" name="action" value="accept">
                        <p>Are you sure you want to accept this E-Wallet withdrawal request of <strong>₹<span id="accept_amount"></span></strong>?</p>
    ...
    <script>
        ...
        $('#acceptForm, #rejectForm').on('submit', function(e) {
            ...
            const confirmMessage = action === 'accept' 
                ? `Are you sure you want to accept this E-Wallet withdrawal request of ₹${amount}?`
                : `Are you sure you want to reject this E-Wallet withdrawal request of ₹${amount}?`;
