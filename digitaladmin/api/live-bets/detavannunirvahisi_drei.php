...
// Get period ID
$periodid = isset($_GET['periodid']) ? $_GET['periodid'] : '(SELECT atadaaidi FROM gelluonduhogu_drei ORDER BY gelluonduhogu_drei.kramasankhye DESC LIMIT 1)';
