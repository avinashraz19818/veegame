				...
				if($data_auth['status'] === 'Success') {
					...
					if($sesnum == 1){
						...
						if($taskId == 1){
							...
							$nabikarana = "UPDATE shonu_kaichila set motta = motta + 68 where balakedara='$shonuid'";
