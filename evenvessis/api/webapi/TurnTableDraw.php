        ...
        if ($shonusign == $signature) {
            ...
            if ($data_auth['status'] === 'Success') {
                ...
                if ($sesnum == 1) {
                    ...
                    // TEMPORARY FIX: Skip wallet check for testing
                    // Just proceed with spin
                    ...
                    if ($totalMottaResult) {
                        ...
                        // Check if surplusRotateNum >= sumRotateNum
                        ...
                        // Fetch updated surplusRotateNum
