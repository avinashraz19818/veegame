			...
			if($shonusign == $signature){
				...
				if($data_auth['status'] === 'Success') {
					...
					if($sesnum == 1){
						...
						// FIXED: Each bonus should check for its own rechargeAmount threshold
						$data[0]['id'] = 8;
						...
						$data[0]['isFinshed'] = $risotto > 0 ? false : false;
						...
						$data[2]['id'] = 6;
						$data[2]['rewardAmount'] = 3888;
						$data[2]['rechargeAmount'] = 50000;
						$data[2]['order'] = 7;
						$data[2]['state'] = 1;
						$data[2]['createTime'] = '2024-04-05 15:23:59';
						$data[2]['lastUpdateTime'] = '2024-04-05 15:24:25';
						$data[2]['canReceive'] = $mamashri >= 50000 ? true : false; // FIXED: Changed from 30000 to 50000
						$data[2]['isFinshed'] = $risotto > 0 ? true : false;
						
						$data[3]['id'] = 5;
						$data[3]['rewardAmount'] = 1188;
						$data[3]['rechargeAmount'] = 12000;
						$data[3]['order'] = 6;
						$data[3]['state'] = 1;
						$data[3]['createTime'] = '2024-04-05 15:23:44';
						$data[3]['lastUpdateTime'] = '2024-04-05 15:24:24';
						$data[3]['canReceive'] = $mamashri >= 12000 ? true : false; // FIXED: Changed from 10000 to 12000
						$data[3]['isFinshed'] = $risotto > 0 ? true : false;
						
						$data[4]['id'] = 4;
						$data[4]['rewardAmount'] = 588;
						$data[4]['rechargeAmount'] = 6000;
						$data[4]['order'] = 5;
						$data[4]['state'] = 1;
						$data[4]['createTime'] = '2024-03-22 17:30:32';
						$data[4]['lastUpdateTime'] = '2024-04-05 15:23:33';
						$data[4]['canReceive'] = $mamashri >= 6000 ? true : false; // FIXED: Changed from 3000 to 6000
						$data[4]['isFinshed'] = $risotto > 0 ? true : false;
						
						$data[5]['id'] = 3;
						$data[5]['rewardAmount'] = 128;
						$data[5]['rechargeAmount'] = 1200;
						$data[5]['order'] = 4;
						$data[5]['state'] = 1;
						$data[5]['createTime'] = '2024-03-22 17:30:17';
						$data[5]['lastUpdateTime'] = '2024-04-05 15:23:11';
						$data[5]['canReceive'] = $mamashri >= 1200 ? true : false; // FIXED: Changed from 1000 to 1200
						$data[5]['isFinshed'] = $risotto > 0 ? true : false;
						
						$data[6]['id'] = 1;
						$data[6]['rewardAmount'] = 68;
						$data[6]['rechargeAmount'] = 600;
						$data[6]['order'] = 2;
						$data[6]['state'] = 1;
						$data[6]['createTime'] = '2024-03-22 17:29:40';
						$data[6]['lastUpdateTime'] = '2024-04-05 15:22:38';
						$data[6]['canReceive'] = $mamashri >= 600 ? true : false; // FIXED: Changed from 300 to 600
						$data[6]['isFinshed'] = $risotto > 0 ? true : false;
						
						$data[7]['id'] = 2;
						$data[7]['rewardAmount'] = 38;
						$data[7]['rechargeAmount'] = 300;
						$data[7]['order'] = 1;
						$data[7]['state'] = 1;
						$data[7]['createTime'] = '2024-03-22 17:29:51';
						$data[7]['lastUpdateTime'] = '2024-04-05 15:22:29';
						$data[7]['canReceive'] = $mamashri >= 300 ? true : false; // FIXED: Changed from 100 to 300
