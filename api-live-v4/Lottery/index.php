...
try {
    ...
    switch ($action) {
        ...
        case 'WinGoBet': sl_ok(sl_place_bet($user,$input),402);
        ...
        case 'GetMigrationStatus': sl_ok(['state'=>app_setting('migration_state','preview'),'legacyHistoryUrl'=>'/veegame-legacy-history.html']);
